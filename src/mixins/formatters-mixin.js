...
export function formattersFactory(i18n = false, callback = false, remote = false) {
    ...
    return {
        ...
        methods: {
            formatValue(value) {
                if(i18n && !this._.isNil(this.i18nPrefix)) return this.i18nTranslate(value)
                if(callback && !this._.isNil(this.format)) return this.translate(value)
                return value
            },
            async asyncFormatValue(value) {
                if(i18n && !this._.isNil(this.i18nPrefix)) return this.i18nTranslate(value)
                if(callback && !this._.isNil(this.format)) return await this.asyncTranslate(value)
